      ...
      <div className="sectionPadding">
        <div class={style.textWrapper}>
          ...
          <p>
            ...
            embarrassed, and even a little afraid to enter into therapy. With
            this in mind, I not only validate these concerns, but I encourage
            you all the more to reach out despite these feelings as often time
            these emotions are indicative of how therapy can actually be helpful
            for us. For some, it may be their first time exploring therapy as an
            option. My hope is that you feel supported in our work together.
          </p>
        </div>
      </div>
      {/* <Arrow /> */}
