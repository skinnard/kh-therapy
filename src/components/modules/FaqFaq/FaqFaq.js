...
import style from './faqFaq.module.scss'

const ServicesFaq = () => {
  return (
    <div className={`sectionPadding-both ${style.servicesFaq}`}>
      <Faq 
      title={'How much will it cost if I do 1 million sessions 3 days a week for ht resto of my life??ost if I do 1 million sessions 3 days a week for ht resto of my life??' }
